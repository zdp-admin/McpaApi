...
public class GarageCommercialDbContext : DbContext
{
  public GarageCommercialDbContext(DbContextOptions<GarageCommercialDbContext> options) : base(options) { }
  ...
  protected override void OnModelCreating(ModelBuilder modelBuilder)
  {
    ...
    modelBuilder.Entity<Documents>(entity =>
    {
      ...
      entity.HasOne(d => d.Client).WithMany(c => c.Documents).HasForeignKey(d => d.IdClientProveedor);
    });
