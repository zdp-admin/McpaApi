...
namespace McpaApi.Database.Mysql
{
    public class ShopAguaAzulDbContext : DbContext
    {
        public ShopAguaAzulDbContext(DbContextOptions<ShopAguaAzulDbContext> options) : base(options) { }
