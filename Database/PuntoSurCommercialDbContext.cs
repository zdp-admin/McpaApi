...
public class PuntoSurCommercialDbContext : DbContext
{
  public PuntoSurCommercialDbContext(DbContextOptions<PuntoSurCommercialDbContext> options) : base(options) { }
